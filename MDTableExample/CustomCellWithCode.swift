...
class CustomCellWithCode: SystemTableViewCell {
    ...
    override func render(with row: TableRow) {
        ...
        guard let row = row as? CustomCodeRow else {
            return
        }
